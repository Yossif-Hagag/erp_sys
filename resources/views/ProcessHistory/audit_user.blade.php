            ...
            <div class="content col-10 flex-column align-items-center d-flex  justify-content-between p-0 h-auto">
                ...
                <div class="options text-center w-100" id="options">
                    <ul id="options-list">
                        ...
                        <li>
                            <a href="{{ route('audit_user') }}" id="audit_user"
                ...
                <div class="table-data pe-1 overflow-y-scroll w-100">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($x->old_values as $key => $value)
                                            <div>
                                                @if ($key == 'name')
                                                    <span class="text-danger">إسم</span>
                                                @elseif ($key == 'phone')
                                                    <span class="text-danger">الهاتف</span>
                                                @elseif ($key == 'job_type')
                                                    <span class="text-danger">الوظيفة</span>
                                                @elseif ($key == 'salary')
                                                    <span class="text-danger">المرتب</span>
                                                @elseif ($key == 'holidays')
                                                    <span class="text-danger">أجازات</span>
                                                @elseif ($key == 'holi_rest')
                                                    <span class="text-danger">باقي أجازات</span>
                                                @elseif ($key == 'over_time')
                                                    <span class="text-danger">وقت إضافي</span>
                                                @elseif ($key == 'email')
                                                    <span class="text-danger">البريد الإلكتروني</span>
                                                @elseif ($key == 'password')
                                                    <span class="text-danger">كلمة المرور</span>
                                                @elseif ($key == 'emp_file')
                                                    <span class="text-danger">المرفقات</span>
                                                @elseif ($key == 'id')
                                                    <span class="text-danger">معرف المنتج</span>
                                                @else
                    ...
                    <div class="paginate px-4" style="direction: ltr;">{{ $users_audits->links() }}</div>
                </div>
                <!-- End Data -->
