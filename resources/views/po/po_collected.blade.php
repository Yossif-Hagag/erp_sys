...
<body>
                ...
                <div class="buttons position-relative row m-0 py-3">
                    <div class="col-6">
                        <div class="wrap w-100">
                            <form action="{{ route('po_collection.search') }}" method="get" id="po-collection-form"
                                class="search w-100 position-relative d-flex">
                                <button type="submit" class="searchButton text-center text-white">
                                    <i class="fa fa-search"></i>
                                </button>
                                <input type="text" id="po_collection_keyword"
                    ...
                    <div class="col-6 text-start">
                        <a href="{{ route('po_collection_pdf') }}" class="btn btn-dark ms-2">
    ...
    <script>
        ...
        $('#po_collected').addClass('active-page');
    </script>
</body>
