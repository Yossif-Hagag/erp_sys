...
<head>
  ...
  <title>تعديل منتج || العربي جروب</title>
    ...
    <div class="content-body row m-0">
      ...
      <div class="content col-10 mt-5 overflow-y-scroll h-100">
        <div id="edtproduct">
          ...
          @endforeach
          @endif
          <form method="POST" action="{{route('update_product',[$supplier->id,$product->id])}}"
            ...
            <div class="mb-4 d-block text-end">
              ...
              <select class="form-select select2" id="pro_num" aria-label="Default select example" name="pro_num" required>
                <option selected value="{{ old('product_num', $product->pro_num)}}">
                  @foreach ($pros as $pro)
                  @if ($pro->code == $product->pro_num)
                  {{ $pro->name }}
                  @endif
                  @endforeach
                </option>
            ...
            <div class="mb-4 d-block">
              ...
              <input type="number" class="form-control" id="supply-price" name="number_of_product"
                value="{{ old('number_of_product', $product->number_of_product)}}" required />
            </div>
            {{-- <div class="mb-5 text-end">
