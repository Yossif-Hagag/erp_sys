...
<head>
    ...
    <title>إضافة منتج || العربي جروب</title>
        ...
        <div class="content-body row m-0">
            ...
            <div class="content col-10 mt-5 overflow-y-scroll h-100">
                ...
                @if ($errors->count() > 0)
                    ...
                    @endforeach
                @endif
                <div id="addcatalogue" style="margin-bottom: 5rem">
                    <form action="{{ route('store_catalogue') }}" method="POST"
                        class="w-50 h-100 mx-auto rounded-4 p-4 text-end">
                        @csrf

                        <div class="mb-4">
                            <label for="product_num" class="form-label">كود المنتج</label>
                            <input type="number" class="form-control" id="product_num" name="code" required />
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="suppliers" rows="5" name="suppliers"></textarea>
                        </div>
