        ...
        <div class="content-body row m-0">
            ...
            <div class="content col-10 flex-column align-items-center d-flex  justify-content-between p-0 h-auto">
                ...
                <div class="table-data  pe-1 overflow-y-scroll w-100">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($x->old_values as $key => $value)
                                            <div>
                                                @if ($key == 'amount')
                                                    <span class="text-danger">المبلغ</span>
                                                @elseif ($key == 'reason')
                                                    <span class="text-danger">سبب الصرف</span>
                                                @elseif ($key == 'recipient')
                                                    <span class="text-danger">المستلم</span>
                                                @elseif ($key == 'id')
                                                    @continue;
                                                @else
                    ...
                    <div class="paginate px-4" style="direction: ltr;">{{ $audit_expense->links() }}</div>
                </div>
                <!-- End Data -->
