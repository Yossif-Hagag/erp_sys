            ...
            <div class="content col-10 flex-column align-items-center d-flex  justify-content-between p-0 h-auto">
                ...
                <div class="options text-center w-100" id="options">
                    <ul id="options-list">
                        ...
                        <li>
                            <a href="{{ route('audit_po') }}" id="audit_po"
                ...
                <div class="table-data  pe-1 overflow-y-scroll w-100">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($x->old_values as $key => $value)
                                            <div>
                                                @if ($key == 'status')
                                                    <span class="text-danger">الحالة</span>
                                                @elseif ($key == 'snum')
                                                    <span class="text-danger">الكود</span>
                                                @elseif ($key == 'from')
                                                    <span class="text-danger">العميل</span>
                                                @elseif ($key == 'po_value')
                                                    <span class="text-danger">القيمة</span>
                                                @elseif ($key == 'collection_date')
                                                    <span class="text-danger">تاريخ التحصيل</span>
                                                @elseif ($key == 'po_file')
                                                    <span class="text-danger">صورة ال(PO) </span>
                                                @elseif ($key == 'sale_present_file')
                                                    <span class="text-danger">مرفق عرض السعر</span>
                                                @elseif ($key == 'id')
                                                    @continue;
                                                @else
                    ...
                    <div class="paginate px-4" style="direction: ltr;">{{ $po_audits->links() }}</div>
                </div>
                <!-- End Data -->
