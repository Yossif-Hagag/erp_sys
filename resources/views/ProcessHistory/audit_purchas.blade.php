            ...
            <div class="content col-10 flex-column align-items-center d-flex  justify-content-between p-0 h-auto">
                ...
                <div class="options text-center w-100" id="options">
                    <ul id="options-list">
                        ...
                        <li>
                            <a href="{{ route('audit_purchas') }}" id="audit_purchas"
                ...
                <div class="table-data pe-1 overflow-y-scroll w-100">
                        ...
                        <tbody id="data-body">
                            @foreach ($allPurchas as $x)
                                <tr>
                                    ...
                                    <td>{{ $x->event }}</td>
                                    <td>
                                        @foreach ($purchas as $pur)
                                            @if ($x->auditable_id == $pur->id)
                                                {{ $pur->pro_name }}
                                            @endif
                                        @endforeach
                                    </td>
                                    <td>
                                        @foreach ($x->old_values as $key => $value)
                                            <div>
                                                @if ($key == 'supply_file')
                                                    <span class="text-danger">ملف التوريدة</span>
                                                @elseif ($key == 'num_of_products')
                                                    <span class="text-danger">عدد المنتجات</span>
                                                @elseif ($key == 'total_price')
                                                    <span class="text-danger">إجمالي السعر</span>
                    ...
                    <div class="paginate px-4" style="direction: ltr;">{{ $allPurchas->links() }}</div>
                </div>
                <!-- End Data -->
            </div>
            <!-- End Content -->
