        ...
        <div class="content-body row m-0">
            ...
            <div class="content col-10 flex-column align-items-center d-flex  justify-content-between p-0 h-auto">
                ...
                <div class="table-data pe-1 overflow-y-scroll w-100">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($x->old_values as $key => $value)
                                            <div>
                                                @if ($key == 'name')
                                                    <span class="text-danger">الإسم</span>
                                                @elseif ($key == 'phone')
                                                    <span class="text-danger">الهاتف</span>
                                                @elseif ($key == 'address')
                                                    <span class="text-danger">العنوان</span>
                                                @elseif ($key == 'email')
                                                    <span class="text-danger">البريد الإلكتروني</span>
                                                @elseif ($key == 'price_offer  ')
                                                    <span class="text-danger">عرض السعر</span>
                                                @elseif ($key == 'id')
                                                    @continue;
                                                @else
                    ...
                    <div class="paginate px-4" style="direction: ltr;">{{ $audit_agents->links() }}</div>
                </div>
                <!-- End Data -->
