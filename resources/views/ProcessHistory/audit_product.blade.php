...
<body>
 ...
 <div class="options text-center w-100" id="options">
    <ul id="options-list">
        <li>
            <a href="{{ route('audit_product') }}" id="audit_product"
                class="btn btn-sm btn-light ms-2 active-btn-hisproc">
                المخزن
            </a>
        </li>
        <li>
            <a href="{{ route('audit_supplier') }}" id="audit_supplier" class="btn btn-sm btn-light ms-2">
                الموردين
            </a>
        </li>
        <li>
...
<div class="table-data pe-1 overflow-y-scroll w-100">
    ...
    <div class="paginate px-4" style="direction: ltr;">{{ $all->links() }}</div>
</div>
<!-- End Data -->
