        ...
        <div class="content-body row m-0 overflow-y-scroll">
            ...
            <div class="content col-10 py-1 overflow-hidden">
                ...
                <div class="buttons position-relative row m-0 py-3">
                    <div class="col-6">
                        <div class="wrap w-100">
                            <form action="{{ route('operation_stock.search') }}" method="get"
                                id="operation_stock-form" class="search w-100 position-relative d-flex">
                                <button type="submit" class="searchButton text-center text-white">
                                    <i class="fa fa-search"></i>
                                </button>
                                <input type="text" id="operation_stock_keyword"
                    ...
                    <div class="col-6 text-start">
                        <a href="{{ route('operation_stockpdf') }}" class="btn btn-dark">
                            <i class="fa fa-download ms-2"></i>PDF
                        </a>
                        <a href="{{ route('addNewOperationStock.addNewOperation') }}" class="btn btn-dark">
                        ...
                        <!-- End Total Tag -->
                        <a href="{{ route('product') }}" class="btn btn-dark">
                ...
                <div class="table-data pe-1 h-auto">
                    ...
                    <div class="paginate px-4" style="direction: ltr;">{{ $OperationgStocks->links() }}</div>
                </div>
                <!-- End Data -->
            </div>
            <!-- End Content -->
